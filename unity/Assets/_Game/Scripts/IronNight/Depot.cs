...
namespace IronNight
{
    ...
    public static class Depot
    {
        ...
        // the men are the roster's (Crew); the generation counter is kept only for old saves
        ...
        public static string CrewMan(int role) => Crew.Chosen(Nation, CrewRoles[role]).name;   // the man in the seat
